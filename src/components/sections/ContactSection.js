        ...
        <section id="contact" className="section-card section-shell scroll-mt-24">
            <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
                    ...
                    <div className="rounded-2xl border border-sky-200/70 bg-gradient-to-br from-sky-50 to-teal-50 p-6 dark:border-emerald-500/20 dark:from-emerald-950/40 dark:to-teal-950/40">
                        ...
                        <div className="mt-7 space-y-4">
                            <div className="flex items-center gap-3 rounded-xl border border-white/80 bg-white/70 px-4 py-3 dark:border-emerald-500/20 dark:bg-slate-900/50">
                                <Mail size={18} className="text-sky-700 dark:text-emerald-400" />
                                <p className="text-base font-medium text-slate-700 dark:text-slate-300">Available for collaboration</p>
                            </div>
                            <div className="flex items-center gap-3 rounded-xl border border-white/80 bg-white/70 px-4 py-3 dark:border-emerald-500/20 dark:bg-slate-900/50">
                                <ShieldCheck size={18} className="text-teal-600 dark:text-emerald-400" />
                                <p className="text-base font-medium text-slate-700 dark:text-slate-300">Security-first development approach</p>
                            </div>
                        </div>
                    </div>
                </ScrollAnimation>
                ...
                <ScrollAnimation delay={0.2}>
                    <form ref={formRef} action={formAction} className="rounded-2xl border border-slate-200/80 bg-white/90 p-6 shadow-sm dark:border-emerald-500/20 dark:bg-slate-900">
                        <div className="space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-base text-slate-800 outline-none transition focus:border-sky-500 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-200 dark:focus:border-emerald-500"
                                    value={name}
